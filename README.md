...
Я решил оставить message service и message handler, ведь они могут понадобиться для методов, работающих только с сущностью message - удаление, редактирование сообщений и тд.
